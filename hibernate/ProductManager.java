...
public class ProductsManager {
	...
	public static void main(String[] args) {
		...
		product.setDescription("more durable with sleek design");
		product.setPrice(50000);
		
		// creates product detail
		ProductDetail detail = new ProductDetail();
		detail.setPartNumber("ABCDEFGHIJKL");
		detail.setDimension("3,4m x 1,4m x 1,2m");
		detail.setWeight(2);
		detail.setManufacturer("hp private limited");
		detail.setOrigin("India");
